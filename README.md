...
| **`transformFile`** | A function to transform the default output. Gets invoked with the packages array and should return the content written to the additional file. Can be async or return a Promise. |
